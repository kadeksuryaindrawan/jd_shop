      ...
      <div class="bg-topnav  main-nav">
          <div class="center-topnav">
            <ul class="topnav">
              ...
              <li class="kanan cd-signin"><a href="./auth/login.php"><i class="fas fa-user"></i> My Account </a></li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top bg-color" style="margin-top: -20px;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto" style="letter-spacing: 1px;">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./presentasi.html"> Presentasi </a>
          </li>
        </ul>
                    ...
                    <div class="col-lg-3">
                      <div class="konten-2">
                       ...
                       <p class="harga"><sup>Rp</sup>.<?= number_format($data_product['product_price'], 2, "," , ".")  ?></p>
                          ...
                          <form method="POST" action="./cart.php?id=<?=$data_product['id_product'] ?>">
                            <input type="hidden" name="input_jumlah_beli" value="1">
                            <button class="btn-buy" type="submit" name="add_to_cart"><i class="fas fa-shopping-cart"></i> ADD TO CART </button>
                          </form>
