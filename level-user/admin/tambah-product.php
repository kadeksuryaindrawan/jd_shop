                    ...
                    <table class="table">
                      ...
                      <form action="./process/add-product.process.php" method="POST" enctype="multipart/form-data">
                      	...
                      	<div class="form-group">
                      		...
                      		<input type="text" name="input_product_name" class="form-control">
                      	</div>
                        <div class="form-group">
                            ...
                            <?php 
                              ...
                              if(mysqli_num_rows($query_category) > 0){
                                while($data_category = mysqli_fetch_assoc($query_category)) {
                                  ?>
                                    <option value="<?= $data_category['id_category'] ?>"><?= $data_category['category_name'] ?></option>
                                  <?php
                                }
                              }
                              else{
                      	...
                      	<div class="form-group">
                      		...
                      		<input type="number" name="input_product_price" class="form-control">
                      	</div>

                        <div class="form-group">
                          <label class="bmd-label-floating">Stock</label>
                          <input type="number" name="input_product_stock" class="form-control">
                        </div>
                        <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                      	...
                      	<button type="submit" class="btn btn-success ml-auto" name="add">Add</button>
