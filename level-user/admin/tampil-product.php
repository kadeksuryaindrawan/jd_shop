          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="col-md-2 ml-auto">
                <a href="tambah-product.php" class="btn btn-success">Add Product</a>
              </div>
            </div>
                          ...
                          while($data_product = mysqli_fetch_assoc($query_select_product)) {
                            ?>
                              <tr>
                                ...
                                <td>
                                  <p>Rp.<?= number_format($data_product['product_price'], 2, "," , ".")  ?></p>
                                </td>
                                <td>
                                ...
                                <td>
                                  <a class="text-success" href="./edit-product.php?id=<?php echo $data_product['id_product'] ?>">Edit</a>
                                  |
                                  <a class="text-success" href="./delete-product.php?id=<?php echo $data_product['id_product'] ?>">Delete</a>
                                </td>
