                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <form action="./process/add-category.process.php" method="POST">

                      	<div class="form-group">
                      		<label class="bmd-label-floating">Category Name</label>
                      		<input type="text" name="input_category_name" class="form-control">
                      	</div>
                      	<div class="form-group">
                      		<label>Category Description</label>
                      		<textarea class="ckeditor" id="wysiwyg" name="input_category_description"></textarea>
                      	</div>
