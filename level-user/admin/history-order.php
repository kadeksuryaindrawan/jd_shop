      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">History Order List</a>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="col-md-2 ml-auto">
                <form action="./process/delete-all-history.process.php" method="POST">
                  <button class="btn btn-danger" name="delete" type="submit">Clear all</button>
                </form>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">History Order List</h4>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php  
                          $query_select_history = mysqli_query($connection, "SELECT tb_carts.*,tb_users.email,tb_checkout.* FROM tb_carts INNER JOIN tb_users ON tb_carts.id_user = tb_users.id_user INNER JOIN tb_checkout ON tb_carts.id_cart = tb_checkout.id_cart WHERE tb_carts.status = 'success' || tb_carts.status = '1' ORDER BY tb_checkout.created_at DESC LIMIT 10");
                          while($data_order = mysqli_fetch_assoc($query_select_history)) {
                            ?>
                              <tr>
                                <td>
                                  <?= $data_order['id_cart'] ?>
                                ...
                                <td>
                                  <a href="./process/delete-history.process.php?id=<?= $data_order['id_cart'] ?>" style="color: red"> Delete </a>
                                </td>
                              </tr>
                            <?php
                          }
